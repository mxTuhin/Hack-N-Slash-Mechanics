...
public class CharacterConstants
{
	...
	/// <summary>
	/// This angle is used to define a valid angle range when limiting the upward displacement magnitude (unstable collide and slide).
	/// </summary>
	public const float MaxUnstableUpwardsAngle = 85f;	
