...
/// </summary>
[AddComponentMenu("Character Controller Pro/Core/Character Graphics/Graphics Root Controller")]
...
public class CharacterGraphicsRootController : CharacterGraphics
{
    ...
    void HandleVerticalDisplacement( float dt )
    {
        ...
        // Debug
        // if( Input.GetMouseButton( 0 ) ) Debug.DrawLine( previousPosition , transform.position , Color.red , 3f );   
